...
public class Hamburger {
    ...
    private String adition1Name;
    private double adition1Price;

    private String adition2Name;
    private double adition2Price;

    private String adition3Name;
    private double adition3Price;

    private String adition4Name;
    ...
    public void addHamburgerAdition1(String name, double price) {
        this.adition1Name = name;
        this.adition1Price = price;
    }

    public void addHamburgerAdition2(String name, double price) {
        this.adition2Name = name;
        this.adition2Price = price;
    }

    public void addHamburgerAdition3(String name, double price) {
        this.adition3Name = name;
        this.adition3Price = price;
    }

    public void addHamburgerAdition4(String name, double price) {
        this.adition4Name = name;
        this.adition4Price = price;
    }

    public double itemizeHamburger() {
        if (adition1Name != null) {
            this.price += this.adition1Price;
        }
        if (adition2Name != null) {
            this.price += this.adition2Price;
        }
        if (adition3Name != null) {
            this.price += this.adition3Price;
        }
        if (adition4Name != null) {
            this.price += this.adition4Price;
        }
        return this.price ;
