...
/*Write a method with the name printDayOfTheWeek that has one parameter of type int and name it day.
 ...
 if the int parameter gdayh is 0, 1, c , 6 respectively, otherwise it should print gInvalid dayh.
...
public class DayOfTheWeeKChallenge {
    ...
    public static void main(String[] args) {
        printDayOfTheWeekSwitc(4);
        printDayOfTheWeekIfElse(3);
        
    }
//Switc case
    private static void printDayOfTheWeekSwitc(int day) {
        switch (day) {
            case 0:
